export const translations = {
  fa: {
    ...
    // Smart Booking Page & Forms
    booking_in_person_badge: "نوبت‌دهی حضوری",
    booking_in_person_title: "دریافت نوبت ویزیت حضوری",
    booking_in_person_desc: "جهت حفظ نظم و هماهنگی با سیستم پذیرش بیمارستان، نوبت‌دهی حضوری از طریق سامانه رسمی بیمارستان نیکان غرب یا تماس تلفنی انجام می‌شود.",
    booking_hospital_department: "کلینیک تخصصی اعصاب و روان (اتاق ۳۰۲)",
    booking_contact_reception: "تماس با پذیرش",
    booking_reception_hours_label: "ساعات پاسخگویی",
    booking_reception_hours_val: "شنبه تا چهارشنبه: ۹ الی ۱۸",
    booking_hospital_portal_btn: "ورود به سامانه نوبت‌دهی بیمارستان",
    booking_want_online_btn: "تمایل به ویزیت آنلاین دارم",
    booking_secure_badge: "سامانه نوبت‌دهی امن و محرمانه",
    booking_online_title: "رزرو نوبت ویزیت آنلاین",
    booking_registered_title: "نوبت شما ثبت شد",
    booking_online_desc: "لطفاً اطلاعات زیر را با دقت تکمیل فرمایید. پس از ثبت، کد پیگیری از طریق تلگرام برای شما ارسال می‌شود.",
    booking_registered_desc: "اطلاعات نوبت شما با موفقیت ثبت شد. لطفاً کد پیگیری را یادداشت فرمایید.",
    booking_tab_online: "ویزیت آنلاین",
    booking_tab_inperson: "ویزیت حضوری",
    booking_form_title: "فرم درخواست نوبت آنلاین",
    booking_form_subtitle: "تمام فیلدهای ستاره‌دار الزامی هستند",
    booking_fullname_label: "نام و نام خانوادگی",
    booking_fullname_placeholder: "مثال: علی احمدی",
    booking_phone_label: "شماره موبایل",
    booking_phone_placeholder: "۰۹۱۲۳۴۵۶۷۸۹",
    booking_email_label: "ایمیل (اختیاری)",
    booking_email_placeholder: "example@email.com",
    booking_date_label: "تاریخ نوبت",
    booking_time_label: "ساعت نوبت",
    booking_select_time: "انتخاب ساعت",
    booking_desc_label: "توضیحات (اختیاری)",
    booking_desc_placeholder: "علت مراجعه یا توضیحات اضافی...",
    booking_char_limit: "کاراکتر",
    booking_submit_btn: "ثبت نهایی درخواست نوبت آنلاین",
    booking_submitting_btn: "در حال ثبت درخواست...",
    booking_privacy_note: "اطلاعات شما کاملاً محرمانه بوده و کد پیگیری از طریق تلگرام ارسال می‌شود.",
    booking_help_title: "نیاز به راهنمایی دارید؟",
    booking_help_desc: "تیم پشتیبانی ما در ساعات کاری آماده پاسخگویی است.",
    booking_whatsapp_btn: "واتس‌اپ",
    booking_call_btn: "تماس",
    booking_working_hours: "شنبه تا چهارشنبه: ۹:۰۰ الی ۱۸:۰۰",
    booking_confidential_title: "محرمانگی کامل",
    booking_confidential_desc: "تمام اطلاعات شما طبق کدهای اخلاقی نظام پزشکی محفوظ می‌ماند.",
    booking_fast_title: "پاسخگویی سریع",
    booking_fast_desc: "نوبت شما ظرف چند دقیقه از طریق تلگرام تأیید می‌شود.",
    booking_success_heading: "نوبت شما با موفقیت ثبت شد!",
    booking_tracking_code_label: "کد پیگیری شما:",
    booking_details_title: "جزئیات نوبت",
    booking_patient_name: "نام بیمار",
    booking_contact_phone: "شماره تماس",
    booking_datetime: "تاریخ و ساعت",
    booking_type_label: "نوع ویزیت",
    booking_add_to_calendar: "افزودن به تقویم",
    booking_cal_google: "گوگل",
    booking_cal_outlook: "اوت‌لوک",
    booking_instant_whatsapp: "ارتباط فوری در واتس‌اپ",
    booking_copy_id: "کپی کد پیگیری",
    booking_id_copied: "کد پیگیری کپی شد!",
    booking_return_home: "بازگشت به صفحه اصلی",
    booking_back_to_form: "بازگشت به فرم نوبت‌دهی",
    booking_not_found: "اطلاعات نوبت در دسترس نیست.",
    booking_success_tip: "لطفاً در زمان مقرر آماده مشاوره باشید. در صورت عدم امکان حضور، حداقل ۲۴ ساعت قبل اطلاع دهید.",
    booking_val_name_req: "نام و نام خانوادگی الزامی است",
    booking_val_name_len: "نام باید حداقل ۳ کاراکتر باشد",
    booking_val_phone_req: "شماره موبایل الزامی است",
    booking_val_phone_inv: "فرمت شماره موبایل نامعتبر است (مثال: ۰۹۱۲۳۴۵۶۷۸۹)",
    booking_val_email_inv: "فرمت ایمیل نامعتبر است",
    booking_val_date_req: "تاریخ نوبت الزامی است",
    booking_val_date_past: "تاریخ نمی‌تواند در گذشته باشد",
    booking_val_date_closed: "جمعه‌ها مطب تعطیل است",
    booking_val_time_req: "ساعت نوبت الزامی است",
    booking_unexpected_error: "خطای غیرمنتظره‌ای رخ داد. لطفاً دوباره تلاش کنید.",
    booking_submitted_success_title: "درخواست با موفقیت ثبت شد!",
    booking_submission_error_title: "خطا در ثبت درخواست",
    booking_hero_online_prefix: "رزرو",
    booking_hero_online_highlight: "نوبت ویزیت آنلاین",
    booking_hero_confirmed_prefix: "نوبت شما",
    booking_hero_confirmed_highlight: "ثبت شد",

    // Doctor & Patient Chat
    chat_clinical_threads: "گفتگوهای بالینی مراجعین",
    chat_active_records: "پرونده فعال",
    chat_demo_badge: "داده نمونه",
    chat_encrypted: "ارتباط امن",
    chat_search_placeholder: "جستجوی بیمار یا شماره تماس...",
    chat_no_threads: "گفتگویی با این مشخصات یافت نشد.",
    chat_new_message: "پیام جدید",
    chat_dr_title_full: "دکتر فاطمه مومنی (متخصص اعصاب و روان)",
    chat_mc_code: "نظام پزشکی: ۱۳۳۴۳۹",
    chat_active_channel: "پاسخگویی بالینی فعال",
    chat_hospital_nikan: "بیمارستان نیکان غرب",
    chat_tele_visit: "مشاوره آنلاین تصویری",
    chat_call_patient: "تماس با بیمار",
    chat_call_hospital: "تماس با بیمارستان نیکان غرب",
    chat_no_messages: "هیچ پیامی در این گفتگو ثبت نشده است. اولین پیام را ارسال کنید.",
    chat_dr_name: "دکتر فاطمه مومنی",
    chat_cancel: "انصراف",
    chat_save: "ذخیره تغییرات",
    chat_prescription: "نسخه الکترونیک دارویی",
    chat_rx_verified: "دارای کد پیگیری و مهر دیجیتال",
    chat_download: "دانلود",
    chat_clinical_document: "سند ضمیمه بالینی",
    chat_edited: "(ویرایش شده)",
    chat_options: "گزینه‌ها، واکنش و ویرایش",
    chat_copied: "کپی شد!",
    chat_quick_reaction: "واکنش بالینی / احساسی:",
    chat_copy_message: "کپی متن پیام",
    chat_edit_message: "ویرایش متن پیام",
    chat_delete_message: "حذف پیام",
    chat_delete_confirm: "آیا از حذف این پیام بالینی اطمینان دارید؟",
    chat_toggle_reaction: "کلیک برای تغییر یا ثبت واکنش",
    chat_quick_presets_title: "قالب‌های پاسخ سریع بالینی پزشک:",
    chat_issue_rx: "صدور و ارسال نسخه الکترونیک",
    chat_send_guide: "ارسال راهنمای بالینی و پایش",
    chat_upload_lab: "ارسال فایل آزمایش یا نوار مغز",
    chat_recording_voice: "در حال ضبط پیام صوتی بالینی...",
    chat_send_voice: "ارسال ویس",
    chat_attach_file: "ارسال فایل یا نسخه",
    chat_record_voice: "ضبط پیام صوتی",
    chat_quick_rx_button: "پاسخ‌های آماده",
    chat_input_placeholder_doctor: "تایپ پیام یا توصیه بالینی برای بیمار...",
    chat_input_placeholder_patient: "پیام یا سوال خود از دکتر فاطمه مومنی را بنویسید...",
    chat_send_btn: "ارسال پیام",
    chat_status_read: "خوانده و مشاهده شده (دو تیک رنگی)",
    chat_status_delivered: "تحویل داده شد (دو تیک خاکستری)",
    chat_status_sent: "ارسال به سرور انجام شد (تک تیک)",
    chat_voice_dr_memo: "پیام صوتی توضیحات بالینی و راهنمای درمانی دکتر فاطمه مومنی",
    chat_voice_patient_memo: "پیام صوتی شرح حال مراجع",
    chat_rx_generated_alert: "نسخه الکترونیک و دستور دارویی رسمی با مهر نظام پزشکی صادر شد.",
    chat_guide_attached_alert: "فایل راهنمای بالینی و پایش سلامت پیوست گردید.",
    chat_lab_attached_alert: "فایل گزارش آزمایشگاهی ضمیمه شد.",
    chat_rx_download_alert: "دریافت فایل نسخه:",
    chat_file_view_alert: "مشاهده فایل:",

    social_title: "شبکه‌های اجتماعی و رسانه",
    social_instagram: "صفحه رسمی اینستاگرام",
    developer_full_credit: "توسعه‌دهنده و سفارش سامانه: محمدحسین"
  },
  ...
  en: {
    ...
    // Smart Booking Page & Forms
    booking_in_person_badge: "In-Person Appointments",
    booking_in_person_title: "Book In-Person Consultation",
    booking_in_person_desc: "To ensure streamlined scheduling with the hospital admission desk, in-person consultations are arranged via Nikan Gharb Hospital's official portal or direct reception line.",
    booking_hospital_department: "Psychiatry & Behavioral Health Clinic (Suite 302)",
    booking_contact_reception: "Hospital Reception",
    booking_reception_hours_label: "Operating Hours",
    booking_reception_hours_val: "Saturday - Wednesday: 09:00 - 18:00",
    booking_hospital_portal_btn: "Open Hospital Booking Portal",
    booking_want_online_btn: "Switch to Online Telehealth",
    booking_secure_badge: "Confidential & Encrypted Telehealth",
    booking_online_title: "Book Online Psychiatric Consultation",
    booking_registered_title: "Appointment Registered",
    booking_online_desc: "Please fill out the form carefully. Upon submission, a tracking code and appointment confirmation will be issued.",
    booking_registered_desc: "Your consultation request was submitted successfully. Please record your tracking code.",
    booking_tab_online: "Online Telehealth",
    booking_tab_inperson: "In-Person Visit",
    booking_form_title: "Online Consultation Request Form",
    booking_form_subtitle: "All asterisked fields are required",
    booking_fullname_label: "Full Name",
    booking_fullname_placeholder: "e.g., John Smith",
    booking_phone_label: "Mobile Phone Number",
    booking_phone_placeholder: "09123456789 or +98912...",
    booking_email_label: "Email Address (Optional)",
    booking_email_placeholder: "example@email.com",
    booking_date_label: "Appointment Date",
    booking_time_label: "Appointment Time",
    booking_select_time: "Select Preferred Time",
    booking_desc_label: "Clinical Notes / Reason for Visit (Optional)",
    booking_desc_placeholder: "Reason for visit or additional clinical notes...",
    booking_char_limit: "characters",
    booking_submit_btn: "Confirm Online Consultation Request",
    booking_submitting_btn: "Submitting Request...",
    booking_privacy_note: "Your health information is strictly confidential and protected under medical privacy ethics.",
    booking_help_title: "Need Assistance?",
    booking_help_desc: "Our clinical reception is available during business hours.",
    booking_whatsapp_btn: "WhatsApp",
    booking_call_btn: "Call Reception",
    booking_working_hours: "Saturday to Wednesday: 09:00 - 18:00",
    booking_confidential_title: "Strict Confidentiality",
    booking_confidential_desc: "All patient information is held in strict compliance with medical confidentiality ethics.",
    booking_fast_title: "Rapid Confirmation",
    booking_fast_desc: "Your appointment is confirmed promptly via automated dispatch.",
    booking_success_heading: "Your Appointment is Confirmed!",
    booking_tracking_code_label: "Your Tracking Code:",
    ...
    booking_type_label: "Consultation Mode",
    booking_add_to_calendar: "Add to Calendar",
    booking_cal_google: "Google",
    booking_cal_outlook: "Outlook",
    booking_instant_whatsapp: "Instant WhatsApp Chat",
    booking_copy_id: "Copy Tracking Code",
    booking_id_copied: "Tracking Code Copied!",
    booking_return_home: "Return to Homepage",
    booking_back_to_form: "Back to Booking Form",
    booking_not_found: "Booking data is unavailable.",
    booking_success_tip: "Please be ready at your scheduled time. If rescheduling is needed, please notify at least 24 hours prior.",
    booking_val_name_req: "Full name is required",
    booking_val_name_len: "Name must be at least 3 characters",
    booking_val_phone_req: "Mobile number is required",
    booking_val_phone_inv: "Invalid mobile number format (e.g. 09123456789)",
    booking_val_email_inv: "Invalid email format",
    booking_val_date_req: "Appointment date is required",
    booking_val_date_past: "Date cannot be in the past",
    booking_val_date_closed: "Clinic is closed on Fridays",
    booking_val_time_req: "Appointment time is required",
    booking_unexpected_error: "An unexpected error occurred. Please try again.",
    booking_submitted_success_title: "Request Submitted Successfully!",
    booking_submission_error_title: "Submission Error",
    booking_hero_online_prefix: "Book",
    booking_hero_online_highlight: "Online Consultation",
    booking_hero_confirmed_prefix: "Appointment",
    booking_hero_confirmed_highlight: "Confirmed",

    // Doctor & Patient Chat
    chat_clinical_threads: "Patient Clinical Threads",
    chat_active_records: "active records",
    chat_demo_badge: "Demo Data",
    chat_encrypted: "Encrypted Channel",
    chat_search_placeholder: "Search patient name or phone...",
    chat_no_threads: "No clinical threads found.",
    chat_new_message: "New message",
    chat_dr_title_full: "Dr. Fatemeh Momeni (M.D., Psychiatrist)",
    chat_mc_code: "Medical Council: 133439",
    chat_active_channel: "Active Clinical Channel",
    chat_hospital_nikan: "Nikan Gharb Hospital",
    chat_tele_visit: "Telehealth Video Consultation",
    chat_call_patient: "Call Patient",
    chat_call_hospital: "Call Nikan Hospital",
    chat_no_messages: "No messages yet in this conversation. Send the first message.",
    chat_dr_name: "Dr. Fatemeh Momeni",
    chat_cancel: "Cancel",
    chat_save: "Save Changes",
    chat_prescription: "Electronic Medical Prescription",
    chat_rx_verified: "Verified Digital Rx & Medical Seal",
    chat_download: "PDF",
    chat_clinical_document: "Clinical Document",
    chat_edited: "(edited)",
    chat_options: "Options, Reaction & Edit",
    chat_copied: "Copied!",
    chat_quick_reaction: "Clinical / Emotional Reaction:",
    chat_copy_message: "Copy Message",
    chat_edit_message: "Edit Message",
    chat_delete_message: "Delete Message",
    chat_delete_confirm: "Are you sure you want to delete this clinical message?",
    chat_toggle_reaction: "Toggle reaction",
    chat_quick_presets_title: "Doctor Clinical Quick Presets:",
    chat_issue_rx: "Issue Electronic Rx",
    chat_send_guide: "Send Clinical Guide",
    chat_upload_lab: "Upload Lab / EEG File",
    chat_recording_voice: "Recording Clinical Voice Note...",
    chat_send_voice: "Send Voice",
    chat_attach_file: "Attach File or Rx",
    chat_record_voice: "Record Voice Note",
    chat_quick_rx_button: "Quick Rx",
    chat_input_placeholder_doctor: "Type clinical message or prescription for patient...",
    chat_input_placeholder_patient: "Type your message or question for Dr. Momeni...",
    chat_send_btn: "Send Message",
    chat_status_read: "Read & Seen (double blue ticks)",
    chat_status_delivered: "Delivered (double grey ticks)",
    chat_status_sent: "Sent to Server (single tick)",
    chat_voice_dr_memo: "Dr. Fatemeh Momeni Clinical Voice Memo",
    chat_voice_patient_memo: "Patient Clinical Voice Message",
    chat_rx_generated_alert: "Official Medical Prescription Generated with Digital Medical Seal.",
    chat_guide_attached_alert: "Clinical Guide & Health Monitoring File Attached.",
    chat_lab_attached_alert: "Laboratory Test Report Attachment Added.",
    chat_rx_download_alert: "Downloading prescription file:",
    chat_file_view_alert: "Viewing clinical file:",

    social_title: "Social Media & Media",
    social_instagram: "Official Instagram Page",
    developer_full_credit: "Developer & Systems Architecture: Mohammad Hussein"
  }
};
