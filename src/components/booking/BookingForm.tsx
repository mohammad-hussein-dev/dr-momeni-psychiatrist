 ...
 *              dynamic multilingual validation, and smooth feedback.
 *
    ...
    const validateField = useCallback((field: keyof IFormState, value: string): string => {
        ...
        switch (field) {
            ...
            case 'phone':
                ...
                // Support both Iranian standard (09...) and international phone numbers
            ...
            case 'date':
                ...
                if (selectedDate.getDay() === 5) return t('booking_val_date_closed');
                return '';
            case 'time':
